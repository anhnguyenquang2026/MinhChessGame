...
export default function SidePanel({ mode, elo, history, status, roomUrl, onlineConnected, onlineRole, onlineError, onSetMode, onSetElo, onNewGame, onUndo, onFlip, onResign }) {
